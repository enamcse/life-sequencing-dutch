#!/bin/bash
#SBATCH --job-name=eval-buckets-white
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python evaluate_bucket_similarity_over_years_OSSC.py \
  --parquet_file "/gpfs/ostor/ossc9424/data/eh2/population_rinpersoon_year_bucketID_white.parquet" \
  --year1_list 2009 2010 \
  --end_year 2020 \
  --sample_size 1000000 \
  --output_file "/gpfs/ostor/ossc9424/data/eh2/fibo_tanzir/eval_results_white.csv"
