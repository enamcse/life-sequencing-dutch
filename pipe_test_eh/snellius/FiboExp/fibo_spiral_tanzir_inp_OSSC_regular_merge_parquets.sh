...
python merge_parquet_by_prefix.py --input_dir "/gpfs/ostor/ossc9424/data/eh2/fib_spiral_tanzir_regular" --prefix "population_" --output_file "/gpfs/ostor/ossc9424/data/eh2/fib_spiral_tanzir_regular/population_rinpersoon_year_bucketID_regular.parquet"
